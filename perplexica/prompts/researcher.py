"""
Researcher prompts for different search modes
"""
from datetime import datetime


def get_speed_prompt(action_desc: str, i: int, max_iteration: int, file_desc: str = "") -> str:
    """Get prompt for speed mode"""
...
def get_quality_prompt(action_desc: str, i: int, max_iteration: int, file_desc: str = "") -> str:
    """Get prompt for quality mode"""
    today = datetime.now().strftime("%B %d, %Y")
...
def get_researcher_prompt(
    ...
    """Get researcher prompt based on mode"""
    mode_handlers = {
        "speed": get_speed_prompt,
        "balanced": get_balanced_prompt,
        "quality": get_quality_prompt
    }

    handler = mode_handlers.get(mode, get_balanced_prompt)
    return handler(action_desc, i, max_iteration, file_desc)
